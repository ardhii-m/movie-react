...
function MovieDetail({ title, tagline, releaseDate, duration, vote_average, overview, poster_path, genres, cast }) {
  return (
    <section className='max-w-4xl mx-auto p-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        ...
        <div className="my-4 space-y-2">
          ...
          <p className="text-xl text-gray-600">{tagline || 'N/A'}</p>

          {/* Release Date */}
          <h4 className="text-2xl font-medium">Release Date</h4>
          <p className="text-xl text-gray-600">{releaseDate}</p>

          {/* Duration */}
          <h4 className="text-2xl font-medium">Duration</h4>
          <p className="text-xl text-gray-600">{duration} minutes</p>
          ...
          <p className="text-justify text-xl text-gray-700">
            {cast.length > 0 ? cast.join(', ') : "No cast information available."}
          </p>
        </div>
      </div>
      ...
      <div className='sm:my-4'>
        ...
        <p className="text-justify text-xl text-gray-700">{overview}</p>
      </div>
    </section>
  );
}
